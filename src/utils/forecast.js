     ...
     request({url,json:true},(error,{body})=>{
        // const data=JSON.parse(response)
         if(error){
             ...
             callback(undefined,'It is currently '+body.main.temp+' Degree Celsius & its '+body.weather[0].description+'. Minimum temperature recorded today is '+body.main.temp_min+' & Maximum temperature recorded today is '+body.main.temp_max)
         }
     })
